...
*   **The Role of the MLS**
    As an MLS, you are a critical user of this pipeline. Your role includes initiating the analysis, performing the first-line QC checks on the run data, recognizing when a pipeline fails, and managing the large data files produced
